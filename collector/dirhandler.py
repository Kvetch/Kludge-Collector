...
class DirHandler(object):
	...
	def	create_dir(self):
		...
		_ofolder = var.outputdir + "/" + os.uname()[1] + "-" + var.timestmp
	...
	def	create_subdirs(self):
		...
		os.makedirs(var.outputdir +	"/Procs")
	...
	def	create_errorlog(self):
		"""	Create Error Log """
		var.err_file = os.uname()[1] + "-" + var.timestmp +	"-error.log"
		var.errorlog = open(var.outputdir +	"/"	+ var.err_file,	"w")
		var.errorlog.writelines("Kludge	Error Log for "	+ os.uname()[1])
